...
dataCleaner = DataNormalizer("extra_extra_training_dataset.csv");
meanArray, standardDeviationArray = dataCleaner.cleanData(labelCol = 2002, outputFileName = "normalized_extra_extra_training_dataset.csv")

dataCleaner = DataNormalizer("extra_extra_test_dataset.csv");
dataCleaner.cleanTestData(labelCol = 2002, meanArray = meanArray, standardDeviationArray = standardDeviationArray, outputFileName = "normalized_extra_extra_test_dataset.csv")
